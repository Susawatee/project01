...
// ดึงข้อมูลทั้งหมด
$sql = "SELECT timestamp, book_number, date, `from`, from_other, `to`, to_other, subject, note FROM book_entries";
...
<body>
    <div class="container">
        ...
        <a href="page.html" class="back-button">กลับ</a>
    </div>
    <script>
